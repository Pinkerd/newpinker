...
<div class="box">
    <form action="http://localhost:8080/pinker/UsersServlet?method=findId&status=0" method="post" id="idFrom">
    ...
    <form action="http://localhost:8080/pinker/UsersServlet?method=findName&status=0" method="post">

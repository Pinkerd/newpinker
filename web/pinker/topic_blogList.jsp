					...
					<div class="content1">
			           ...
			           <div class="content2">
						  ...
						  <div class="actions">
							...
							<button class="title-attentionBtn">关注问题</button>
						  </div>
				       </div>
					</div>
					...
					<div class="main-article">
						...
						<div class="main-article01">
							...
							<div class="article-introduce">
								<p>一般来说，每个人都对自己的身体拥有消极的不被干涉的权利。例如除了涉及严重传染病这种公共卫生危机的问题之外，每个人都可以自己决定是否接受治疗，在一些有选择的情况下，选择接受何种治疗。在这个语境下，我并不十分理解题目中为何限定“慢性病患者”，…</p>
							</div>

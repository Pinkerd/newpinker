...
public class EmailUtils {
    ...
    private static final String FROM = "ff978043238@qq.com";

    /**
     * 注册成功后,向用户发送帐户激活链接的邮件
     * @param user 未激活的用户
     */
    public static void sendAccountActivateEmail(pk_user user) {
     ...
     * 发送重设密码链接的邮件
     */
    public static void sendResetPasswordEmail(pk_user user) {
        Session session = getSession();
        MimeMessage message = new MimeMessage(session);
        try {
